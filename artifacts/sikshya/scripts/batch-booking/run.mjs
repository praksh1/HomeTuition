...
try {
  for (const width of [390, 1440]) {
    ...
    check(`${width}: student history is visible without another hidden menu`, studentMoney.includes("History") && studentMoney.includes("Test receipt TEST-BATCH-1") && studentMoney.includes("Nepal time"));
    ...
    check(`${width}: teacher sees expected, pending and test-paid earnings`, teacherMoney.includes("Expected test earnings") && teacherMoney.includes("Pending test earnings") && teacherMoney.includes("Test-paid to you"));
    ...
    check(`${width}: teacher history names the student and receipt`, teacherMoney.includes("Student: Synthetic Student") && teacherMoney.includes("Test receipt TEST-BATCH-1"));
