...
- [ ] Implement the make-up/remedy workflow. Owner approved launch policy 26 September: one teacher-approved courtesy replacement per missed student lesson, seven-day offer expiry, replacement within thirty days, missed replacements manually reviewed, teacher non-delivery preserves refund review, no automatic refund or forfeiture. Preserve original entitlements and serialize replacement/refund operations. See the policy document for time-anchor details still to make explicit.
...
## Make-up policy (approved in principle 26 September, NOT implemented or active)
