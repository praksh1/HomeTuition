...
| **Jitsi as a Service (8x8)** | monthly active *device* | $99/300 MAU · $499/1,500 · $999/3,000 · $0.99 over | **≈ 10** |
...
**2. Jitsi as a Service bills per monthly active *device*, and that is upside-down from
...
only as the platform *grows* — which is the bill you want, because growth arrives with revenue
...
LiveKit on Hetzner is ~$0.60 — but because it is the cheapest thing the owner can run *without
becoming an operations engineer*, and the owner is non-technical. The gap is about $470/month at
...
tiers are per *account*, not per teacher, so they vanish into rounding at any real scale.
